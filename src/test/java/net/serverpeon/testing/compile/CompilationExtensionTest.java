...
class CompilationExtensionTest {
    ...
    class MethodExtendWith extends ExtensionTests {
        ...
        @ExtendWith(CompilationExtension.class)
        @Test
        public void getElements(Elements elements) {
        ...
        @ExtendWith(CompilationExtension.class)
        @Test
        public void getTypes(Types types) {
        ...
        @ExtendWith(CompilationExtension.class)
        @Test
        public void elementsAreValidAndWorking(Elements elements) {
        ...
        @ExtendWith(CompilationExtension.class)
        @Test
        public void typeMirrorsAreValidAndWorking(Elements elements, Types types) {
